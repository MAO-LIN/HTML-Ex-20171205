        ...
        <div style="margin: 0 0 0 0;padding: 10px 10px 10px 10px;background-color: ;">
            <form action="links_add.php" method="POST">
                <div class="form-group">
                    <label for="title" style="font-size: 1.5em">連結說明:</label>
                    <input type="text" class="form-control" id="title" name="title">
                </div>
                <div class="form-group">
                    <label for="link" style="font-size: 1.5em">連結網址:</label>
                    <input type="text" class="form-control" id="link"  name="link">
                </div>
                <div class="form-group">
                    <label for="style" style="font-size: 1.5em">分類</label>
                    <select class="form-control" id="style" name="style">
                        <option value="1">English Learning</option>
                        <option value="2">其他連結</option>
                    </select>
                </div>
